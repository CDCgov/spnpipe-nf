...
# Replaces EMBOSS transeq
sed -i '1d' temp1.fna
NA2AA.pl temp1.fna > temp2.faa

echo ">Sample1" > Sample_PBP1A_AA.faa
grep -v ">" temp2.faa >> Sample_PBP1A_AA.faa
...
grep -v ">" temp2.faa >> Sample_PBP2B_AA.faa
...
grep -v ">" temp2.faa >> Sample_PBP2X_AA.faa
